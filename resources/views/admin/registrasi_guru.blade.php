  ...
  // JUDUL //
    ...
    <section class="flex flex-col items-center pt-36 px-6 w-full">
      ...
      <form id="formContainer" action="{{ route('admin.storeGuru') }}" method="POST"
        class="space-y-4 relative z-10" autocomplete="off"> @csrf
      <div>
    ...
    <div class="w-full flex justify-end mt-8 pr-12">
        <a href="{{ route('admin.informasiRingkas') }}" 
          class="text-white/60 font-semibold hover:text-white transition text-sm flex items-center gap-1">
            BACK HOME <span class="text-lg">›</span>
        </a>
    </div>
    </section>
